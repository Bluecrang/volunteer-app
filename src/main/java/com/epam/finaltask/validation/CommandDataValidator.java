...
/**
 * Class that is used to check if command is allowed to be executed by user and with chosen http method.
 */
public class CommandDataValidator {

    /**
     * Checks if account type and http method are allowed by constraints.
     * @param data Data that is used by command
     * @param constraints Object that contains allowed account types and http method
