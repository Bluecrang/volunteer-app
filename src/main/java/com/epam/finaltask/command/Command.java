...
public abstract class Command {
     ...
     * @return CommandResult, which contains page to move to and transition type
    ...
    /**
     * Method which is used in {@link Command#execute(CommandData)}. Defines what command should do.
     * @param data Data which is used to perform action
